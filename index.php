    ...
    if(empty($_POST['name'])){
      ...
      { 
        if ($ext == "jpg" || $ext == "png" || $ext == "jpeg"){
                ...
                $msg=$ob->register($_POST['uname'],$_POST['email'],$_POST['name'],$_POST['age'],$_POST['city'],$fn);
      ...
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3">
          ...
          <div class="card-body p-4 p-md-5">
            ...
            <h5 class="mb-4 pb-2 pb-md-0 mb-md-5 px-md-2">Add Employee</h5>
